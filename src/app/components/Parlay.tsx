...
//   let betcruncher, slip, selections;
...
//   selections = [{ odds: '+735', terms: '1/4', position: 1 }];
...
//         const home_team =
//           data[index].matchups[0].odds[3].markets[0].outcomes[0].price;
//         const away_team =
//           data[index].matchups[0].odds[3].markets[0].outcomes[0].price;
...
//         />{' '}
//         to win ${betcruncher(slip, selections).returns.toFixed(2)}
//       </span>
//     </>
//   );
// }
